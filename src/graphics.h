...
extern void fillcolorvertical(void *p_colors, unsigned int color, int size,
                              int rect_width);

/* rect_width is in pixels not bytes */
extern void fillgradient(void *p_colors, unsigned int start_color,
                         unsigned int end_color, int size, int rect_width);

HBITMAP createstylerect(HDC hdc, int w, int h);
HBITMAP createinvertrect(HDC hdc, int w, int h);
